...
public:
                     ...
                     accumulated_cloud_(new pcl::PointCloud<pcl::PointXYZ>())
    {
        ...
        // 声明参数：保存PCD文件的目录
        this->declare_parameter<std::string>("save_path","/assets/pcd_maps");
        ...
        RCLCPP_INFO(this->get_logger(), "开始累积点云（合并所有接收帧）...");
    }
...
private:
        ...
        std::shared_ptr<std_srvs::srv::Empty::Response> response)
    {
        ...
        // 保存累积的完整点云
        if (pcl::io::savePCDFileBinary(filename, *accumulated_cloud_) == 0) {  
